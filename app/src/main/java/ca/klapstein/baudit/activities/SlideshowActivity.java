...
public class SlideshowActivity extends AppCompatActivity implements SlideShowView {
    ...
    private class SlideshowAdapter extends PagerAdapter {
        ...
        /**
         * Get the number of photos stored in bitmap array.
         *
         * @return {@code int}
         */
        @Override
         ...
         * {@code instantiateItem(ViewGroup, int)}.
         */
        @Override
        ...
        /**
         * Create the slideshow page for the given image.
         */
        @NonNull
        @Override
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            layoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            View slideShowLayout = layoutInflater.inflate(R.layout.slideshow_layout, container, false);

            ImageView imageView = slideShowLayout.findViewById(R.id.image_view);
            imageView.setImageBitmap(RotateBitmap90(bitmapArrayList.get(position)));

            container.addView(slideShowLayout);
